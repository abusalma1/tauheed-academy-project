...
<body style="font-family: 'DejaVu Sans', sans-serif; font-size:15px;">
    ...
    <div style="width:100%; padding-left: 5px;  padding-right: 5px;" id="result-1">
      ...
      <div style="text-align:center; border-bottom:3px solid #000; padding-bottom:8px; margin-bottom:8px;">
        ...
        <div style="
                                ...
                                ">
          No.1 Tsafe Road, Gidan Madawaki Isah
      ...
      <table style="width:100%; border-collapse:collapse; margin-bottom:10px;">
        <tr>
          ...
          <td style="border-bottom:1px solid #000; ">ADM/2025/001</td>
      ...
      <div style="margin-top:20px; font-size:13px;">
        ...
        <table style="width:100%; border-collapse:collapse; margin-bottom:12px;">
          <tr>
            ...
            <td style="border-bottom:1px solid #000; "> <span style="font-family: 'DejaVu Sans', sans-serif;">₦</span>76,000</td>

...
if (isset($_GET['id'])) {
    $id = (int) $_GET['id'];
    $stmt = $pdo->prepare("SELECT picture_path, id FROM students WHERE id = ? ");
    $stmt->execute([$id]);
...
<body class="bg-gray-50">
    ...
    <section class="bg-gradient-to-r from-blue-900 to-blue-800 text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-4xl md:text-5xl font-bold mb-4">Upload Students Avatar"</h1>
            <p class="text-xl text-blue-200">Update students profile picture across all platforms</p>
        </div>
    </section>
                        ...
                        <div class="flex flex-col items-center gap-6">
                            <div class="relative">
                                ...
                                <img id="currentAvatar"
                                    src="<?= !empty($student['picture_path']) ? asset($student['picture_path']) : asset('/images/avatar.png') ?>"

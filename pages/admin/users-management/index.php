        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    if (!isset($user_type) || $user_type === 'admin') :
                        if ($user['type'] === 'superAdmin') : ?>
                            <a href="<?= route('admin-create') ?>" class="flex items-center gap-3 p-4 border-2 border-purple-200 rounded-lg hover:bg-purple-50 transition">
                    ...
                    <a href="<?= route('teacher-create') ?>" class="flex items-center gap-3 p-4 border-2 border-blue-200 rounded-lg hover:bg-blue-50 transition">
                    ...
                    <a href="<?= route('guardian-create') ?>" class="flex items-center gap-3 p-4 border-2 border-green-200 rounded-lg hover:bg-green-50 transition">
                    ...
                    <a href="<?= route('student-create') ?>" class="flex items-center gap-3 p-4 border-2 border-orange-200 rounded-lg hover:bg-orange-50 transition">

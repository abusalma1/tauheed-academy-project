...
<<<<<<< HEAD
/* ------------------------------
   FETCH EXISTING CLASS-SUBJECT LINKS
------------------------------ */
...
<<<<<<< HEAD
/* ------------------------------
   FETCH OTHER SUBJECTS (FOR DUPLICATE CHECKS IF NEEDED)
------------------------------ */

$subjects = selectAllData('subjects', true, $subject_id);
...
<<<<<<< HEAD
            ...
            // Soft-delete existing class_subjects for this subject
            $delStmt = $pdo->prepare("
            ...
            // Insert new class_subject mappings
            ...
            foreach ($class_ids as $cid) {
                $insertPivot->execute([(int)$cid, $subject_id]);
=======
            // Update subject name

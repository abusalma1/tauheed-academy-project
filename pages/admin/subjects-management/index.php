...
$stmt = $pdo->prepare("
    ...
    ORDER BY c.level ASC, subj.name ASC
");
...
$classesForFilter = selectAllData('classes', true); // true = filter deleted rows
...
$totalSubjects = countDataTotal('subjects', true)['total'];
$totalStudents = countDataTotal('students', true)['total'];
$totalSections = countDataTotal('sections', true)['total'];
$totalClasses  = countDataTotal('classes', true)['total'];

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name)) $errors[] = 'Term name is required';
...
<body class="bg-gray-50">
    ...
    <div class="max-w-2xl mx-auto px-4 py-8">
        <!-- Header -->
        <div class="mb-8">
            <a href="terms.php" class="text-blue-600 hover:text-blue-900 mb-4 inline-flex items-center gap-2">
            ...
            <p class="text-gray-600">Create a new academic term</p>
        </div>
        ...
        <div class="bg-green-50 border-l-4 border-green-500 p-4 mb-6 rounded">
            <div class="flex items-center gap-2">
                ...
                <p class="text-green-700 font-medium">Term created successfully!</p>
            </div>
        </div>
        <?php endif; ?>
            ...
            <form method="POST" class="space-y-6">
                <div>
                    <label class="block text-sm font-semibold text-blue-900 mb-2">
                        <i class="fas fa-heading"></i> Term Name
                    </label>
                    <input type="text" name="name" placeholder="e.g., First Term" 
                ...
                <div class="flex gap-3 pt-4">
                    ...
                    <a href="terms.php" class="flex-1 bg-gray-300 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-400 transition font-medium flex items-center justify-center gap-2">

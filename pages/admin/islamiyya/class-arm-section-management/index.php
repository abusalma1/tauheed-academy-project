        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition">
                    ...
                    <a href="<?= route('islamiyya-arms-management') ?>" class="inline-block w-full text-center bg-teal-600 text-white py-2 rounded-lg font-semibold hover:bg-teal-700 transition">
                        <i class="fas fa-arrow-right mr-2"></i>Manage
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <a href="<?= route('create-islamiyya-class') ?>" class="flex items-center gap-3 p-4 border-2 border-indigo-200 rounded-lg hover:bg-indigo-50 transition">
                    ...
                    <a href="<?= route('create-islamiyya-section') ?>" class="flex items-center gap-3 p-4 border-2 border-cyan-200 rounded-lg hover:bg-cyan-50 transition">
                    ...
                    <a href="<?= route('create-islamiyya-class-arm') ?>" class="flex items-center gap-3 p-4 border-2 border-teal-200 rounded-lg hover:bg-teal-50 transition">
                    ...
                    <a href="<?= route('islamiyya-classes-management') ?>" class="flex items-center gap-3 p-4 border-2 border-indigo-200 rounded-lg hover:bg-indigo-50 transition">

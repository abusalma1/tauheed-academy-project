<?php
$title = "Islamiyya Classes Management";
...
$stmt = $pdo->prepare("
    SELECT 
        ...
        islamiyya_class_teachers.id AS class_teacher_id,
        islamiyya_class_teachers.name AS class_teacher_name,
...
// Counts (Islamiyya tables only; students table is shared)
...
<body class="bg-gray-50">
    ...
    <section class="bg-green-900 text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-4xl md:text-5xl font-bold mb-4">Islamiyya Classes by Section</h1>
            <p class="text-xl text-green-200">View all islamiyya classes organized by educational sections with their arms</p>
        </div>
    </section>
            ...
            <div class="mb-8 bg-white rounded-lg shadow-lg p-6">
                <div class="flex flex-col md:flex-row gap-4">
                    ...
                    <div class="flex items-end">
                        <a href="<?= route('create-islamiyya-class') ?>" class="w-full md:w-auto bg-green-900 hover:bg-green-800 text-white font-semibold py-2 px-6 rounded-lg transition flex items-center justify-center gap-2">
                                        ...
                                        <tr
                                            ...
                                            <td class="px-6 py-4 text-sm text-slate-600">
                                                <div class="flex items-center justify-center gap-4">
                                                    <a href="<?= route('islamiyya-class-performance') . '?class_id=' . $class['class_id'] ?>&arm_id=<?= $class['arm_id'] ?>">
                                                        <button class="text-blue-600 hover:text-blue-900 font-semibold flex items-center gap-1">
                                                            <i class="fas fa-eye"></i> view class
                                                        </button>
                                                    </a>
                                                    <a href="<?= route('assing-islamiyya-class-teacher') . '?class_id=' . $class['class_id'] . '&arm_id=' .  $class['arm_id']; ?>">

                                                        <button class="text-blue-600 hover:text-blue-900 font-semibold flex items-center gap-1">
                                                            <i class="fas fa-user-plus"></i> Add/Edit Teacher
                                                        </button>
                                                    </a>
                                                    <a href="<?= route('update-islamiyya-class') . '?id=' . $class['class_id'] ?>">
                                                        <button class="text-blue-600 hover:text-blue-900 font-semibold flex items-center gap-1">
                                                            <i class="fas fa-edit"></i> Edit
                                                        </button>
                                                    </a>
                                                    <a href="<?= route('delete-islamiyya-class') ?>?id=<?= $class['class_id'] ?>">

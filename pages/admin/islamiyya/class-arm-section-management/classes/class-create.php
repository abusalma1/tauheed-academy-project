                    ...
                    <div class="bg-white rounded-lg shadow-lg p-8">
                        ...
                        <form id="classForm" class="space-y-6" method="post">
                            ...
                            <div>
                                ...
                                <span class="text-gray-500 text-sm">Click Here to <a href="<?= route('create-islamiyya-class-arm') ?>" class="text-blue-700 font-bold underline cursor-pointer">Create Class Arms</a></span><br>
                            ...
                            <div>
                                ...
                                <span class="text-gray-500 text-sm">Click Here to <a href="<?= route('create-islamiyya-section') ?>" class="text-blue-700 font-bold underline cursor-pointer">Create Sections</a></span>
                                ...
                                <?php foreach ($classes as $class): ?>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 text-sm space-x-2">
                                            <a href="<?= route('update-islamiyya-class'); ?>?id=<?= $class['id'] ?>">
                                                <button class="text-blue-600 hover:text-blue-900 font-semibold">
                                                    <i class="fas fa-edit"></i> Edit
                                                </button>
                                            </a>

                                            <a href="<?= route('delete-islamiyya-class') ?>?id=<?= $class['id'] ?>"

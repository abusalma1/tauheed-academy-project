...
<html lang="en">
  <head>
    ...
    <title>Manage Subjects Results - Excellence Academy</title>
        ...
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs text-blue-200">Teacher Portal</p>
            </div>
          </div>
                  ...
                  <div class="flex-1">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <span
                          class="px-2 py-1 bg-green-100 text-green-900 rounded-full text-xs font-semibold"
                          >Uploaded</span
                        >
                      </div>
                      <div>
                  ...
                  <div class="flex-1">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      ...
                      <div>
                        <p class="text-gray-600">Status</p>
                        <span
                          class="px-2 py-1 bg-yellow-100 text-yellow-900 rounded-full text-xs font-semibold"
                          >Pending</span
                        >
                      </div>
                      <div>

...
<head>
    ...
    <title>Update Guardian Account - Excellence Academy</title>
...
<body class="bg-gray-50">
    ...
    <nav class="bg-blue-900 text-white sticky top-0 z-50 shadow-lg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center gap-6">
                    <a href="guardian-management.html" class="hover:text-blue-300 transition">Back to Guardians</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-blue-800 px-4 py-4 space-y-2">
            <a href="guardian-management.html" class="block py-2 hover:bg-blue-700 px-3 rounded">Back to Guardians</a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                <div class="bg-white rounded-lg shadow-lg p-8">
                    ...
                    <form id="updateGuardianForm" class="space-y-6">
                        <!-- Full Name -->
                        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        <li><a href="guardian-management.html" class="text-gray-400 hover:text-white transition">Guardian Management</a></li>
                    </ul>
                </div>
                <div>
    ...
    <script>
        ...
        const guardianIndex = new URLSearchParams(window.location.search).get('index');
        ...
        updateGuardianForm.addEventListener('submit', (e) => {
            ...
            if (isValid) {
                ...
                if (guardianIndex !== null) {
                    ...
                    alert('Guardian account updated successfully!');
                }
                
                window.location.href = 'guardian-management.html';
            }
        });
    </script>
</body>

...
<head>
    ...
    <title>Teacher Management - Excellence Academy</title>
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-8">
                        ...
                        <form id="teacherForm" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="password" id="confirmPassword" name="confirmPassword" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-900" placeholder="Confirm password">
                    ...
                    <div class="mt-6 bg-white rounded-lg shadow p-6">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center pb-3 border-b">
                                ...
                                <span class="text-2xl font-bold text-blue-900" id="totalTeachers">0</span>
                            </div>
                            <div class="flex justify-between items-center pb-3 border-b">
                                <span class="text-gray-600">Active</span>
                                <span class="text-2xl font-bold text-green-600" id="activeTeachers">0</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-gray-600">Inactive</span>
                                <span class="text-2xl font-bold text-red-600" id="inactiveTeachers">0</span>
                            </div>
                        </div>
                    </div>
                </div>

<div class="hidden" style="
                      ...
                      ">
    <!-- A4 Container -->
    <div style="width:100%; padding-left: 5px;  padding-right: 5px;" id="result-<?= $term['term_id'] ?>">
        ...
        <table style="width:100%; border-collapse:collapse; font-size:11px; margin-bottom:12px;">
            ...
            <?php foreach ($term['students'] as $student): ?>
                ...
                <tr>
                    ...
                    <td style="border:1px solid #000;  text-align:center;"><?= $student['total_marks'] ?? '-'  ?></td>
                    <td style="border:1px solid #000;  text-align:center;"><?= $student['average_marks'] ?? '-'  ?></td>
                    <td style="border:1px solid #000;  text-align:center;"><?= $student['position_in_class'] ?? '-'  ?></td>
                    <td style="border:1px solid #000;  text-align:center;"><?= $student['overall_grade']  ?? '-' ?></td>

<?php if (isset($_SESSION['success'])): ?>
    <div id="successAlert"
        class="fixed top-18 left-1/2 transform -translate-x-1/2 mt-4 px-6 py-3 bg-green-600 text-white rounded-full shadow-lg opacity-0 translate-y-[-100%] transition-all duration-500 ease-in-out z-[9999]">

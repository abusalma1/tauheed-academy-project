<?php if (isset($_SESSION['failure'])): ?>
    <div id="failureAlert"
        class="fixed top-4 left-1/2 transform -translate-x-1/2 mt-4 px-6 py-3 bg-red-600 text-white rounded-full shadow-lg opacity-0 translate-y-[-100%] transition-all duration-500 ease-in-out z-[9999]">
